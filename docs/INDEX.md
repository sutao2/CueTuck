...
| 路径 | 状态 | 何时读 | 一句话 |
|---|---|---|---|
| [plans/2026-09-13-viewer-launcher-polish.md](plans/2026-09-13-viewer-launcher-polish.md) | 进行中 | 精简启动器、图片查看器、紧凑卡片与新图标 | beta.7 Mac 已安装，真实卡片/预览/启动器与新图标已验；Windows 构建中 |
