...
<style scoped>
.operations .panel-heading{padding:0 0 20px}.operations-period select{font:inherit;color:inherit;background:#fff;border:1px solid var(--line-strong);border-radius:7px;padding:10px 12px;min-height:42px}
