...
<style scoped>
.review-files { padding: 16px 0; border-top: 1px solid #e5e8eb; margin-top: 16px; } .review-file, header { display: flex; gap: 16px; align-items: center; justify-content: space-between; } .review-file { padding: 12px 0; border-bottom: 1px solid #e5e8eb; } small { display: block; margin-top: 4px; color: #7c858d; } .review-file-preview { padding: 16px; background: #f7f8fa; border-radius: 10px; margin-top: 16px; } header { margin-bottom: 16px; } header strong { margin-right: auto; overflow-wrap: anywhere; } img { display: block; max-width: 100%; max-height: 420px; margin: auto; } pre { white-space: pre-wrap; overflow-wrap: anywhere; max-height: 360px; overflow: auto; }
</style>
