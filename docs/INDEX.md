...
| 路径 | 状态 | 何时读 | 一句话 |
|---|---|---|---|
| [plans/2026-09-18-beta18-release.md](plans/2026-09-18-beta18-release.md) | 准备发行 | beta.18 双平台及服务器部署 | 合集修复与固定签名预览发行 |
| [plans/2026-09-18-collections.md](plans/2026-09-18-collections.md) | 已实现并验收，未发版 | 合集成员创建、封面发布及九宫格 | 专属成员、审核媒体封面与比例布局 |
