export const adminPages = ['overview', 'audit', 'system', 'review', 'skill-review', 'content', 'users', 'billing', 'categories', 'models', 'reports', 'rules', 'moderation', 'ai-models', 'ai-skills', 'translation', 'mail', 'notifications', 'identity', 'oauth', 'settings', 'security'];

export const adminNavGroups = [
  { label: '工作空间', items: [{ page: 'overview', icon: 'cyan' }, { page: 'users', icon: 'user' }, { page: 'billing', icon: 'file' }] },
  { label: '内容与目录', items: [{ page: 'review', icon: 'shield' }, { page: 'skill-review', icon: 'skills' }, { page: 'content', icon: 'square' }, { page: 'translation', icon: 'globe' }, { page: 'categories', icon: 'folder' }, { page: 'models', icon: 'models' }, { page: 'reports', icon: 'rose' }] },
...
export function permittedPage(page, permissions = {}) {
  ...
  if (['notifications', 'audit', 'system', 'oauth', 'settings', 'moderation', 'ai-models', 'ai-skills', 'translation', 'mail', 'identity'].includes(page) && !permissions.configuration) return false;
