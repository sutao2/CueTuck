...
视觉规则见 [ADR 0015](../../architecture/decisions/0015-workbench-visual-system.md)。主窗口使用系统无衬线字体、统一线性图标和中性色表面；绿色用于重点操作和选中项。标题、正文、辅助信息有清晰字号层级；筛选栏和卡片随可用宽度排列，状态栏不抢占内容注意力。
