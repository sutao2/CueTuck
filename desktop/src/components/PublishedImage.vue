<template>
  <button ref="element" type="button" class="published-image" :aria-label="`查看 ${title || file.name} 的图片`" @click.stop="open">
...
.published-image span { display:grid; place-items:center; width:100%; height:100%; min-height:80px; font-size:12px; }
</style>
