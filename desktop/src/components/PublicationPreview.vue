<template>
  <section class="publication-preview" aria-label="发布预览" data-testid="publication-preview">
    ...
    <p v-if="!assets.length" class="preview-meta">本次不会公开任何附件或图片。</p>
...
defineProps({ title:String, content:String, category:String, model:String, members:Array, assets:{type:Array,default:()=>[]} });
</script>
<style scoped>
