...
<section class="launch-hero">
  <div class="launch-copy"><a class="release-pill" href="https://github.com/sutao2/CueTuck/releases/tag/v0.1.0-beta.17" target="_blank" rel="noopener"><span></span> v0.1.0-beta.17 · 现已发布 ${icon('arrow')}</a><p class="launch-eyebrow">THE PROMPT LAUNCHER</p><h1>好提示词，<br><em>一键就位。</em></h1><p class="launch-intro">CueTuck · 唤词，你的桌面提示词启动器。<br>一个快捷键，找到模板、填好变量、回车复制。<br>从正在做的事，直接接上下一步。</p><div class="launch-actions"><a class="button dark" href="#download">下载 CueTuck ${icon('arrow')}</a><a class="launch-secondary" href="#app">体验网页广场 ↗</a></div><p class="launch-meta">macOS & Windows <span>·</span> 本地优先 <span>·</span> 开源</p></div>
...
function downloads() { return `<section class="section download-section"><span class="eyebrow">DOWNLOAD CUETUCK</span><h1>下载桌面客户端</h1><p class="muted">本机库、全局启动器与 Skills 管理。当前预览版 v0.1.0-beta.17。</p><div class="download-grid">${[['macOS','Apple 芯片 · DMG','aarch64.dmg'],['Windows','64 位 · EXE','x64-setup.exe']].map(([name,description,file])=>`<article class="download-card"><h2>${name}</h2><p>${description}</p><a class="button dark" href="https://github.com/sutao2/CueTuck/releases/download/v0.1.0-beta.17/CueTuck_0.1.0-beta.17_${file}">下载 ${name} 版 ↓</a></article>`).join('')}</div><p class="download-note">预览版未完成 Apple 公证或 Windows 发布者签名，首次打开可能出现系统提示。</p><a class="text-link" href="https://github.com/sutao2/CueTuck/releases/tag/v0.1.0-beta.17" target="_blank" rel="noopener">发行说明与 SHA-256 校验文件 ↗</a></section>`; }
