...
| [specs/media/spec.md](specs/media/spec.md) | 现行 | 附件传输权限合同 | 私有所有者鉴权；单条/合集稿件审核及公开代理 |
| [plans/2026-09-08-local-completion.md](plans/2026-09-08-local-completion.md) | 目标 | 不依赖外部凭据的后续完善 | P0、P1a/b/c/d、P2 已验；回收、可靠性及发行准备待做 |
